...
public class AudioPlayManager {
	public static final String CACHE_VOICE_FILE_PATH = Environment.getExternalStorageDirectory() + "/emoji/voice/";
	...
	private void downLoadPrepareFile(String url) {
		final File soundFile = new File(AudioRecoderManager.CACHE_VOICE_FILE_PATH + MD5Util.md5(url) + ".amr");
		if (!soundFile.exists()) {
			if (!isDownloading) {
				if (voiceBubbleListener != null) {
